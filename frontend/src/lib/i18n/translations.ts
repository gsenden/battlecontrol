...
export type I18nKey = 'APP_NAME' | 'AUTHENTICATION_FAILED' | 'AUTH_SUBTITLE' | 'AUTH_SUCCESS' | 'CANCEL' | 'DATABASE_ERROR' | 'EMAIL' | 'HOME_SUBTITLE' | 'INVALID_URL' | 'LOGIN' | 'LOGIN_SUBTITLE' | 'LOGIN_WITH_ONE_TIME_CODE' | 'PASSKEY_CANCELLED' | 'PASSKEY_UNAVAILABLE' | 'PLAYER_NAME' | 'REGISTER' | 'REQUEST_FAILED' | 'REQUEST_TIMEOUT' | 'ROOM_NOT_FOUND' | 'SERVER_OFFLINE' | 'SIGN_IN' | 'SIGN_UP' | 'START_BATTLE' | 'USER_ALREADY_EXISTS' | 'USER_NOT_FOUND' | 'WELCOME';

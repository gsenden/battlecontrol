<script lang="ts">
	...
	import { getCurrentUser, loginWithPasskey, toReadableErrorMessage, type UserDto } from '$lib/auth/auth.js';
	...
	<div class="w-full max-w-[760px] text-[#ecf1f7]">
		<div class="mb-12 text-center">
			<div class="mx-auto inline-flex flex-col items-stretch">
				<div class="mt-8">
					<AppTitle className="origin-top scale-[0.66] uppercase" title={t('LOGIN', $currentLanguage)} />
				</div>
			</div>
		</div>
